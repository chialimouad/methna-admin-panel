...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Secondary Stats */}
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatsCard title={t('dashboard.totalLikes')} value={stats.content.totalLikes.toLocaleString()} icon={TrendingUp} iconColor="text-amber-500" />
        ...
        <StatsCard title={t('dashboard.totalPhotos')} value={stats.content.totalPhotos.toLocaleString()} subtitle={`${stats.content.pendingPhotos} ${t('reports.pending')}`} icon={ImageIcon} iconColor="text-purple-500" />
